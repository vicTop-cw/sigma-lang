...
python3 tools/sigma-prove.py corpus/socketkit_ok.md corpus/portfolio_ok.md corpus/inventory_ok.md  # z3 义务消解（73 项 PROVED）
...
```text
  ...
  corpus/ 语料（51 个模块：ok 期望 PASS，break 期望 FAIL）
   ...
   │
   ├──▶ tools/sigma-prove.py     z3 义务消解（73 项 PROVED）
...
| `tools/sigma-prove.py` | 把语料定律编码为 z3 义务并消解 | 73 项 PROVED |
...
**73 项 PROVED**（29 模块）、sigma-runtime **59/59 + 47/47**（--domains 含
