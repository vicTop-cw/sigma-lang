...
三端共识 56/56、数学证明 350 项 PROVED、找茬产品一条命令就能启动上线
...
python3 tools/sigma-runtime.py --domains     # 三域审计故事线一次跑通（95/95）
python3 tools/sigma-prove.py corpus/socketkit_ok.md corpus/portfolio_ok.md corpus/inventory_ok.md  # z3 义务消解（350 项 PROVED）
...
python3 tools/sigma-runtime.py --domains       # 95/95
```
...
```text
  ...
  corpus/ 语料（51 个模块：ok 期望 PASS，break 期望 FAIL）
   ...
   │
   ├──▶ tools/sigma-prove.py     z3 义务消解（350 项 PROVED）
   ├──▶ tools/sigma-runtime.py   审计运行时（trace 59/59 + --domains 95/95）
...
| `tools/sigma-prove.py` | 把语料定律编码为 z3 义务并消解 | 350 项 PROVED |
| `tools/sigma-runtime.py` | 审计运行时：逐事件复核定律（trace / --story / --growth / --inventory / --domains） | 59/59 + 95/95 |
...
**350 项 PROVED**（29 模块）、sigma-runtime **71/71 + 47/47**（--domains 含
...
§PF 金融 / §IN 供应链）——consensus **56/56**、p0 **109/109**、sigma-prove
**350 项 PROVED**（29 模块）、sigma-runtime **71/71 + 71/71**（--domains 含
...
§PF 金融 / §IN 供应链）——consensus **56/56**、p0 **109/109**、sigma-prove
**350 项 PROVED**（30 模块，含 INV-SK-6 额度-托管联动 / INV-PF-4 交易链可加性）、
...
§PF 金融 / §IN 供应链）——consensus **56/56**、p0 **109/109**、sigma-prove
**350 项 PROVED**（31 模块，含 INV-SK-6 额度-托管联动 / INV-PF-4 交易链可加性 /
...
§PF 金融 / §IN 供应链）——consensus **56/56**、p0 **109/109**、sigma-prove
**350 项 PROVED**（32 模块，含 INV-SK-6 额度-托管 / INV-PF-4 交易链可加 /
...
§PF 金融 / §IN 供应链）——consensus **56/56**、p0 **109/109**、sigma-prove
**350 项 PROVED**（33 模块，含 INV-SK-6 额度-托管 / INV-PF-4 交易链可加 /
...
§PF 金融 / §IN 供应链）——consensus **56/56**、p0 **109/109**、sigma-prove
**350 项 PROVED**（34 模块，含 INV-SK-6 额度-托管 / INV-PF-4 交易链可加 /
INV-IN-5 混合货品可加 / INV-SK-7 任务-契分联动 / INV-PF-5 买入-卖出链守恒 /
