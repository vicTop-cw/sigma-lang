...
- [x] **全量重验**: 62 → 322 项 PROVED / 29 模块全绿（> 70 达标）；sigma-accept
...
- [x] **API 文档**: 新建 `docs/api_zhaocha.md`（180 行）——通用约定（鉴权/
      ...
      响应示例）、验收清单；文档与实现双端对应。
- [x] **不回归**: consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.81 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、method-test 4/4、冒烟 36/36、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.82 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **版本升级**: spec 0.4.0 → 0.5.0（README Spec Version + Citation 同步）；
      v0.71–v0.85 的语义面扩展（服务化十件套 + 跨操作不变量 322 项 PROVED）
      满足 0.5.0。
...
- [x] **不回归**: --report 验证 10/10、consensus 56/56、p0 109/109、sigma-prove
      322 项 PROVED、三端 0 warning，v0.10–v0.86 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **收官**: v0.71–v0.90 连续推进收官——找茬开工准备（服务化十件套）、
      业务规则深化（INV-Q/T/G/SK-3/Q-3 跨操作不变量 322 项 PROVED、
      --domains 47/47 十二项复核）、工程化收官（spec 0.5.0、CI 回归报告、
      贡献者指南、README 收官总览）全部达成。
- [x] **门禁**: consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.92 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、web-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.93 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.94 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、panel-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.95 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **上线准备基线**: consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、
      sigma-runtime 71/71 + 47/47、双端冒烟 36/36、sigma-accept 十道门禁
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.100 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、run-accept 8/8、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.101 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 10/10、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.102 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 10/10、concurrency-test
      4/4、consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端
...
- [x] **新不变量义务**: INV-SK-5 契分非负链、INV-G-3 收益不超发链、
      INV-T-3 团队创建合法链。
- [x] **全量重验**: 73 → 322 项 PROVED / 29 模块全绿（> 80 达标）；accept 门禁 8
...
- [x] **不回归**: trace 71/71、--growth 11/11、--inventory 6/6、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.108 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、自检 15/15、冒烟 36/36、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.109 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、自检 15/15、冒烟 36/36、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.110 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --app-smoke 37/37、panel-test 5/5、cargo build 0 warning、
      consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED，v0.10–v0.112 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、web-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.113 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --report 10/10 全绿、runtime 双项 ok、spec 0.7.0、
      consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，
      v0.10–v0.115 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.117 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、bench 4/4、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.120 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: ready 命令实测 7/7、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.121 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **docs/TUTORIAL.md**: 144 行命令级可复现教程——环境准备 / 读规则 /
      ...
      检查清单 / 下一步。
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.123 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、panel-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.133 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、stats-test 5/5、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.137 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、stats-test
      5/5、consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端
...
- [x] **不回归**: trace 71/71、--inventory 6/6、sigma-accept 10/10、consensus
      56/56、p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，
      v0.10–v0.154 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、inventory-test 5/5、portfolio-test 5/5、自检
      15/15、consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端
...
- [x] **不回归**: trace 71/71、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.164 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --cross-domain-test 5/5、--concurrency-test 4/4、--inventory-test
      ...
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.166 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --app-smoke 46/46、--cross-domain-test 5/5、cargo build
      0 warning、consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端
...
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.174 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --errors-test 7/7、--concurrency-test 4/4、自检 15/15、冒烟
      36/36、consensus 56/56、p0 109/109、sigma-prove 322 项 PROVED、三端
...
- [x] **不回归**: web-test 5/5、errors-test 7/7、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.177 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-SK-8（赏金-积分联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.184 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、points-test 3/3、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.187 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-IN-6（入库-出库联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.194 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --inventory-chain-test 5/5、--app-smoke 51/51、Elixir 库存链
      ...
      322 项 PROVED、三端 0 warning，v0.10–v0.200 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-PF-6（交易链完整性）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.204 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --credit-test 3/3、--concurrency-test 4/4、--inventory-chain-test
      ...
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.206 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、credit-test 3/3、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.207 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-SK-9（额度-契分联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.214 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、full-test 5/5、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.217 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-IN-7（混合货品联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.224 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、audit-test 6/6、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.227 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-PF-7（资产链完整性）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.234 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --contribution-test 2/2、--concurrency-test 4/4、--audit-test
      ...
      322 项 PROVED、三端 0 warning，v0.10–v0.236 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-SK-10（契分-贡献联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.244 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --quota-flow-test 2/2、--concurrency-test 4/4、
      ...
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.246 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-SK-11（契分-勋章联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.254 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --badge-test 2/2、--concurrency-test 4/4、--quota-flow-test
      ...
      322 项 PROVED、三端 0 warning，v0.10–v0.256 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、badge-test 2/2、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.257 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-IN-8（混合出库联动）
      复核；门禁 7 期望与 --domains 数字全库同步 71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.264 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --inventory-flow-test 4/4、--concurrency-test 4/4、--badge-test
      2/2、自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、sigma-prove
      322 项 PROVED、三端 0 warning，v0.10–v0.266 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --inventory-flow-test 4/4、--app-smoke 65/65、Elixir 库存流转
      ...
      322 项 PROVED、三端 0 warning，v0.10–v0.270 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--domains 71/71**: run_invariant_checks 追加 INV-PF-8（混合资产链完整性）
      ...
      71/71。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.274 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --portfolio-flow-test 5/5、--concurrency-test 4/4、
      ...
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.276 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --portfolio-flow-test 5/5、--app-smoke 67/67、Elixir 组合流转
      5/5、自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、sigma-prove
      322 项 PROVED、三端 0 warning，v0.10–v0.280 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.284 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --credit-badge-test 3/3、--concurrency-test 4/4、
      ...
      p0 109/109、sigma-prove 322 项 PROVED、三端 0 warning，v0.10–v0.286 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --credit-badge-test 3/3、--app-smoke 70/70、Elixir 三链联动
      ...
      322 项 PROVED、三端 0 warning，v0.10–v0.290 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **INV-SK-13**: 积分-配额联动链（发单 n 次后 remaining=m−n ≥0 且 escrow=n×b），
      PROVED (unsat)；全量 254 → 322 PROVED/34 模块，数字全库同步 322 PROVED。
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、
