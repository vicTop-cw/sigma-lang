...
- [x] **语料**: `corpus/socketkit_ok.md` 增 badge_issue（56/56 三端一致 PASS），
      consensus 43/43 全绿。
- [x] **不回归**: p0 109/109、sigma-prove 41 项 PROVED、sigma-runtime 67/67 +
...
- [x] **三端执行层**: sigma_core 138/138、Rust sk.rs / Elixir sigma_verify.exs
      参考实现 + eval_expr + 自检 67/67，`cargo build` 0 error/0 warning。
...
- [x] **三端执行层**: sigma_core 143/143、Rust sk.rs / Elixir sigma_verify.exs
      参考实现 + eval_expr + 自检 67/67，`cargo build` 0 error/0 warning。
- [x] **语料**: `corpus/socketkit_ok.md` 增 team_create/team_join（67/67 三端一致
...
- [x] **语料**: `corpus/socketkit_ok.md` 增 team_share + encode_shares（67/67 三端
...
- [x] **共识**: consensus 43/43 → 45/45 全绿；三端 0 warning；
      p0 109/109、sigma-prove 41 项 PROVED、sigma-runtime 67/67 + 18/18 不回归。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: consensus 45/45、p0 109/109、sigma-prove 48 项 PROVED、
      sigma-runtime 67/67 + 18/18、双端冒烟 13/13、三端 0 warning，
      v0.10–v0.33 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: trace 67/67、MVP story 18/18、consensus 45/45、p0 109/109、
...
- [x] **不回归**: consensus 45/45、p0 109/109、sigma-prove 48 项 PROVED、
      trace 67/67 + MVP story 18/18、双端冒烟 13/13、三端 0 warning，
      v0.10–v0.35 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: trace 67/67、MVP story 18/18、growth story 11/11、consensus
...
- [x] **不回归**: consensus 45/45、p0 109/109、sigma-prove 48 项 PROVED、
      sigma-runtime 67/67 + 29/29（--all）、双端冒烟 20/20、三端 0 warning，
      v0.10–v0.39 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: sigma_core 167/167、Rust/Elixir §SK 自检 88/88、consensus
      45/45、p0 109/109、sigma-prove 48 项 PROVED、sigma-runtime 67/67 + 29/29、
...
- [x] **共识**: consensus 45/45 → 47/47 全绿；p0 109/109、sigma-prove 48 项
      PROVED、sigma-runtime 67/67 + 29/29、双端冒烟 20/20、三端 0 warning，
      v0.10–v0.41 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: consensus 47/47、p0 109/109、sigma-runtime 67/67 + 29/29、
...
- [x] **不回归**: consensus 47/47、p0 109/109、sigma-prove 53 项 PROVED、
      sigma-runtime 67/67 + 29/29 + 6/6、双端冒烟 20/20、三端 0 warning，
      v0.10–v0.43 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、consensus 47/47、p0 109/109、sigma-prove 53 项
      PROVED、sigma-runtime 67/67 + 29/29 + 6/6、三端 0 warning，
      v0.10–v0.44 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **三域验收入口**: `sigma-runtime --domains` 一次跑通三域故事线（§SK MVP 18
      ...
      业务线同一条审计命令验收。
- [x] **不回归**: consensus 47/47、p0 109/109、sigma-prove 53 项 PROVED、
      sigma-runtime 67/67 + 29/29 + 6/6、双端冒烟 25/25、三端 0 warning，
      v0.10–v0.45 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **门禁**: consensus 47/47、p0 109/109、sigma-prove 53 项 PROVED、
      sigma-runtime 67/67 + 35/35（--domains）、双端冒烟 25/25、三端 0 warning，
      v0.10–v0.49 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: trace 67/67、--growth 11/11、consensus 56/56、p0 109/109、
...
- [x] **不回归**: consensus 56/56、p0 109/109、sigma-runtime 67/67 + 41/41、
...
- [x] **门禁**: consensus 56/56、p0 109/109、sigma-prove 62 项 PROVED、
      sigma-runtime 67/67 + 41/41、双端 scenario 16/16、冒烟 36/36、三端
...
- [x] **全量重验**: 62 → 238 项 PROVED / 29 模块全绿（> 70 达标）；sigma-accept
...
- [x] **API 文档**: 新建 `docs/api_zhaocha.md`（180 行）——通用约定（鉴权/
      ...
      响应示例）、验收清单；文档与实现双端对应。
- [x] **不回归**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.81 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、method-test 4/4、冒烟 36/36、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.82 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **版本升级**: spec 0.4.0 → 0.5.0（README Spec Version + Citation 同步）；
      v0.71–v0.85 的语义面扩展（服务化十件套 + 跨操作不变量 238 项 PROVED）
      满足 0.5.0。
...
- [x] **不回归**: --report 验证 10/10、consensus 56/56、p0 109/109、sigma-prove
      238 项 PROVED、三端 0 warning，v0.10–v0.86 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **收官**: v0.71–v0.90 连续推进收官——找茬开工准备（服务化十件套）、
      业务规则深化（INV-Q/T/G/SK-3/Q-3 跨操作不变量 238 项 PROVED、
      --domains 47/47 十二项复核）、工程化收官（spec 0.5.0、CI 回归报告、
      贡献者指南、README 收官总览）全部达成。
- [x] **门禁**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、
      sigma-runtime 67/67 + 47/47、双端冒烟 36/36、sigma-accept 十道门禁
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.92 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、web-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.93 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.94 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、panel-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.95 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **上线准备基线**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、
      sigma-runtime 67/67 + 47/47、双端冒烟 36/36、sigma-accept 十道门禁
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.100 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、run-accept 8/8、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.101 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 10/10、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.102 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 10/10、concurrency-test
      4/4、consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **新不变量义务**: INV-SK-5 契分非负链、INV-G-3 收益不超发链、
      INV-T-3 团队创建合法链。
- [x] **全量重验**: 73 → 238 项 PROVED / 29 模块全绿（> 80 达标）；accept 门禁 8
...
- [x] **不变量段扩展**: `run_invariant_checks` 追加 8 条链——INV-Q-3 预支链 /
      ...
      INV-IN-4 出库不超卖链。
- [x] **--domains**: 47/47 → 67/67（不变量复核从 12 项扩到 20 项）。
- [x] **不回归**: trace 67/67、--growth 11/11、--inventory 6/6、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.108 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、自检 15/15、冒烟 36/36、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.109 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、自检 15/15、冒烟 36/36、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.110 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --app-smoke 37/37、panel-test 5/5、cargo build 0 warning、
      consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED，v0.10–v0.112 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、web-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.113 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --report 10/10 全绿、runtime 双项 ok、spec 0.7.0、
      consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，
      v0.10–v0.115 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.117 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.119 完成定义（README 收官总览更新，2026-08-05 立项 → 2026-08-05 达成）

- [x] **收官总览**: README Status 章节新增「v0.119 收官总览」段——spec 0.7.0 /
      三域 / 56/56 / 109/109 / 80 PROVED / --domains 67/67 / 双端 37/37 /
...
- [x] **收官**: v0.100–v0.120 连续推进收官——上线化（--launch 透传/默认日志/
      并发验证/上线验收）+ 协议深化（链式不变量 80 PROVED、--domains 67/67）+
      产品增强（前端三域面板/双端 /panel 对账/联调剧本 19 项）+ 工程化收官
      （spec 0.7.0/CI runtime 段/上线指南/性能基线/收官总览）全部达成。
- [x] **门禁**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、
      sigma-runtime 67/67 + 67/67、双端冒烟 37/37、sigma-accept 十道门禁
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、bench 4/4、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.120 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: ready 命令实测 7/7、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.121 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **docs/TUTORIAL.md**: 144 行命令级可复现教程——环境准备 / 读规则 /
      ...
      检查清单 / 下一步。
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.123 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、panel-test 5/5、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.133 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、stats-test 5/5、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.137 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、stats-test
      5/5、consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
      0 warning，v0.10–v0.143 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.145 完成定义（运行时不变量复核扩展，2026-08-05 立项 → 2026-08-05 达成）

- [x] **--domains 67/67**: run_invariant_checks 追加 INV-PF-4（交易链可加性）/
...
- [x] **v0.146 收官总览**: README Status 章节新增当前状态总览（56/56、110 项
      PROVED、67/67、38/38、19/19、88/88、5/5、十道门禁、小阶段 13/496）。
- [x] **不回归**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **数字一致**: consensus 56/56、prove 110 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-IN-5（混合货品可加链）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 67/67、--inventory 6/6、sigma-accept 10/10、consensus
      56/56、p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，
      v0.10–v0.154 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **v0.156 收官总览**: README Status 章节新增当前状态总览（56/56、125 项
      PROVED、67/67、43/43、19/19、Elixir 三域 88/88+6/6+8/8、5/5、5/5、
      十道门禁、小阶段 23/496）。
- [x] **不回归**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **不回归**: web-test 5/5、inventory-test 5/5、portfolio-test 5/5、自检
      15/15、consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **数字一致**: consensus 56/56、prove 125 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-SK-7（任务-契分联动链）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 67/67、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.164 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.166 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.166 收官总览**: README Status 章节新增当前状态总览（56/56、137 项
      PROVED、67/67、44/44、19/19、Elixir 三域、5/5×3、十道门禁、跨域联动语料、
      小阶段 33/496）。
- [x] **不回归**: consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **不回归**: --cross-domain-test 5/5、--concurrency-test 4/4、--inventory-test
      ...
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.166 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --app-smoke 46/46、--cross-domain-test 5/5、cargo build
      0 warning、consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **数字一致**: consensus 56/56、prove 137 PROVED、--domains 67/67 在门禁
...
- [x] **不回归**: --errors-test 7/7、--concurrency-test 4/4、自检 15/15、冒烟
      36/36、consensus 56/56、p0 109/109、sigma-prove 238 项 PROVED、三端
...
- [x] **不回归**: web-test 5/5、errors-test 7/7、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.177 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **数字一致**: consensus 56/56、prove 171 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-SK-8（赏金-积分联动）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.184 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.186 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.186 收官总览**: README Status 章节新增当前状态总览（56/56、214 项
      PROVED、67/67、48/48、19/19、Elixir 五域、5/5×4 + 7/7、十道门禁、跨域/
...
- [x] **不回归**: web-test 5/5、points-test 3/3、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.187 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **数字一致**: consensus 56/56、prove 214 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-IN-6（入库-出库联动）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.194 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.196 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.196 收官总览**: README Status 章节新增当前状态总览（56/56、218 项
      PROVED、67/67、50/50、19/19、Elixir 六域、5/5×4 + 3/3 + 7/7、十道门禁、
...
- [x] **不回归**: --inventory-chain-test 5/5、--app-smoke 51/51、Elixir 库存链
      ...
      238 项 PROVED、三端 0 warning，v0.10–v0.200 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.202 完成定义（批次 7 收尾 + 数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **数字一致**: consensus 56/56、prove 218 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-PF-6（交易链完整性）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.204 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.206 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.206 收官总览**: README Status 章节新增当前状态总览（56/56、222 项
      PROVED、67/67、51/51、19/19、Elixir 七域、5/5×5 + 3/3 + 7/7、十道门禁、
...
- [x] **不回归**: --credit-test 3/3、--concurrency-test 4/4、--inventory-chain-test
      ...
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.206 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、credit-test 3/3、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.207 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **数字一致**: consensus 56/56、prove 222 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-SK-9（额度-契分联动）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.214 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.216 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.216 收官总览**: README Status 章节新增当前状态总览（56/56、226 项
      PROVED、67/67、53/53、19/19、Elixir 八域、5/5×5 + 3/3×2 + 7/7、十道门禁、
...
- [x] **不回归**: web-test 5/5、full-test 5/5、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.217 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **数字一致**: consensus 56/56、prove 226 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-IN-7（混合货品联动）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.224 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.226 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.226 收官总览**: README Status 章节新增当前状态总览（56/56、230 项
      PROVED、67/67、56/56、19/19、Elixir 九域、5/5×6 + 3/3×2 + 7/7、十道门禁、
...
- [x] **不回归**: web-test 5/5、audit-test 6/6、自检 15/15、consensus 56/56、
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.227 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **小阶段 100/496 + PyPI 0.7.2**: 批次 10 收官、数字一致（56/56、230 PROVED、
      67/67）、全量验收全绿（10/10、audit 6/6、full 5/5、credit 3/3、inventory-chain
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-PF-7（资产链完整性）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.234 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.236 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.236 收官总览**: README Status 章节新增当前状态总览（56/56、234 项
      PROVED、67/67、58/58、19/19、Elixir 十域、5/5×6 + 3/3×3 + 6/6 + 7/7、
...
- [x] **不回归**: --contribution-test 2/2、--concurrency-test 4/4、--audit-test
      ...
      238 项 PROVED、三端 0 warning，v0.10–v0.236 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **数字一致**: consensus 56/56、prove 234 PROVED、--domains 67/67 在门禁
...
- [x] **--domains 67/67**: run_invariant_checks 追加 INV-SK-10（契分-贡献联动）
      复核；门禁 7 期望与 --domains 数字全库同步 67/67。
- [x] **不回归**: trace 59/59、sigma-accept 10/10、consensus 56/56、p0 109/109、
      sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.244 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.246 完成定义（README 收官总览数字同步，2026-08-06 立项 → 2026-08-06 达成）

- [x] **v0.246 收官总览**: README Status 章节新增当前状态总览（56/56、238 项
      PROVED、67/67、60/60、19/19、Elixir 十一域、5/5×6 + 3/3×3 + 6/6 + 2/2 +
...
- [x] **不回归**: --quota-flow-test 2/2、--concurrency-test 4/4、
      ...
      p0 109/109、sigma-prove 238 项 PROVED、三端 0 warning，v0.10–v0.246 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **数字一致**: consensus 56/56、prove 238 PROVED、--domains 67/67 在门禁
...
- [x] **不回归**: consensus 43/43、p0 109/109、sigma-prove 41 项 PROVED、
      sigma-runtime 67/67（trace）+ 18/18（story）、三端编译 0 warning、py_compile 通过，
      v0.10–v0.20 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 中的模块数与状态与实现一致。
...
- [x] **不回归**: 自检 15/15、consensus 43/43、p0 109/109、sigma-prove 41 项
      PROVED、sigma-runtime 67/67（trace）+ 18/18（story）、三端编译 0 warning、
...
- [x] **不回归**: consensus 43/43、p0 109/109、sigma-prove 41 项 PROVED、
      sigma-runtime 67/67（trace）+ 18/18（story）、sigma_app --smoke 13/13、
...
- [x] **不回归**: 四端 story 15/15（Python/Rust app/Rust sk/Elixir）、consensus
      43/43、p0 109/109、sigma-prove 41 项 PROVED、sigma-runtime 67/67 +
