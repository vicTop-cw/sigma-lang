...
- [x] **语料**: `corpus/socketkit_ok.md` 增 badge_issue（54/54 三端一致 PASS），
      consensus 43/43 全绿。
...
- [x] **负例补全**: 新增 socketkit_taskflow_break / socketkit_quota_break
      （E-02 三端一致 FAIL）。
- [x] **共识扩容**: consensus 47/47 → 54/54 全绿（> 50 达标）；p0 109/109、
...
- [x] **覆盖扩展**: 业务域 spec 中英对照从 4 个基础文件扩展到 5 个（第三个新域
      首次获得中文参考）。
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 53 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 55 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 57 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 59 项 PROVED、三端
...
- [x] **不回归**: trace 59/59、--growth 11/11、consensus 54/54、p0 109/109、
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-runtime 59/59 + 41/41、
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、persist-test 10/10、consensus 54/54、
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 62 项 PROVED、三端
...
- [x] **门禁**: consensus 54/54、p0 109/109、sigma-prove 62 项 PROVED、
...
- [x] **--auth-test**: 4/4（无 token→401 / 错 token→401 / 对 token→200 /
      业务可用）。
- [x] **不回归**: 自检 15/15、冒烟 36/36、scenario 16/16、consensus 54/54、
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、auth-test 4/4、consensus 54/54、
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、log-test 4/4、consensus 54/54、
...
- [x] **--startup-test**: 3/3（门禁通过 / 失败拒绝（monkeypatch 模拟）/
      通过放行）。
- [x] **不回归**: 自检 15/15、冒烟 36/36、health-test 4/4、consensus 54/54、
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 64 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 66 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 68 项 PROVED、三端
...
- [x] **全量重验**: 62 → 125 项 PROVED / 29 模块全绿（> 70 达标）；sigma-accept
      门禁 8 期望、health gates、README 数字同步为 73 PROVED。
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-accept 9/9、三端 0 warning，
      v0.10–v0.79 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **API 文档**: 新建 `docs/api_zhaocha.md`（180 行）——通用约定（鉴权/
      ...
      响应示例）、验收清单；文档与实现双端对应。
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、
      sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.81 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--frontend-scenario**: 前端视角纯 HTTP 联调剧本——注册→开户→发单→
      ...
      §SK.6 断言。
- [x] **不回归**: 自检 15/15、method-test 4/4、冒烟 36/36、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.82 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **版本升级**: spec 0.4.0 → 0.5.0（README Spec Version + Citation 同步）；
      v0.71–v0.85 的语义面扩展（服务化十件套 + 跨操作不变量 125 项 PROVED）
      满足 0.5.0。
...
- [x] **不回归**: --report 验证 10/10、consensus 54/54、p0 109/109、sigma-prove
      125 项 PROVED、三端 0 warning，v0.10–v0.86 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **收官总览**: README Status 章节更新共识数字（41/41 → 54/54）并新增
      「v0.89 收官总览」段——spec 0.5.0 / 三域 / 54/54 / 109/109 / 73 PROVED /
...
- [x] **收官**: v0.71–v0.90 连续推进收官——找茬开工准备（服务化十件套）、
      业务规则深化（INV-Q/T/G/SK-3/Q-3 跨操作不变量 125 项 PROVED、
      --domains 47/47 十二项复核）、工程化收官（spec 0.5.0、CI 回归报告、
      贡献者指南、README 收官总览）全部达成。
- [x] **门禁**: consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、
      sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.92 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、web-test 5/5、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.93 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **GET /panel**: 运行状态 HTML 面板页——服务信息（用户数/任务数）、
      业务摘要（各状态任务数/赏金总额）、门禁摘要（54/54 / 109/109 /
      73 PROVED / 16/16）。
- [x] **--panel-test**: 5/5（面板可访问 / 实时用户数 / 实时任务数 / 实时赏金 /
      门禁摘要）。
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 5/5、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.94 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、panel-test 5/5、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.95 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **上线准备基线**: consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、
      sigma-runtime 59/59 + 47/47、双端冒烟 36/36、sigma-accept 十道门禁
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、
      sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.100 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、run-accept 8/8、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.101 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **--concurrency-test**: 16 并发客户端 70 请求（20 注册 + 20 开户 +
      ...
      服务存活）。
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 10/10、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.102 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、launch-test 10/10、concurrency-test
      4/4、consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 75 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 76 项 PROVED、三端
...
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 77 项 PROVED、三端
...
- [x] **新不变量义务**: INV-SK-5 契分非负链、INV-G-3 收益不超发链、
      INV-T-3 团队创建合法链。
- [x] **全量重验**: 73 → 125 项 PROVED / 29 模块全绿（> 80 达标）；accept 门禁 8
      期望、health gates、/panel、README/docs 数字同步为 80 PROVED。
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-accept 10/10、三端 0
...
- [x] **不变量段扩展**: `run_invariant_checks` 追加 8 条链——INV-Q-3 预支链 /
      ...
      INV-IN-4 出库不超卖链。
- [x] **--domains**: 47/47 → 58/58（不变量复核从 12 项扩到 20 项）。
- [x] **不回归**: trace 59/59、--growth 11/11、--inventory 6/6、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.108 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、自检 15/15、冒烟 36/36、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.109 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: web-test 5/5、自检 15/15、冒烟 36/36、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.110 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --app-smoke 37/37、panel-test 5/5、cargo build 0 warning、
      consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED，v0.10–v0.112 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、web-test 5/5、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.113 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: --report 10/10 全绿、runtime 双项 ok、spec 0.7.0、
      consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，
      v0.10–v0.115 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、
      sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.117 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.119 完成定义（README 收官总览更新，2026-08-05 立项 → 2026-08-05 达成）

- [x] **收官总览**: README Status 章节新增「v0.119 收官总览」段——spec 0.7.0 /
      三域 / 54/54 / 109/109 / 80 PROVED / --domains 58/58 / 双端 37/37 /
...
- [x] **收官**: v0.100–v0.120 连续推进收官——上线化（--launch 透传/默认日志/
      并发验证/上线验收）+ 协议深化（链式不变量 80 PROVED、--domains 58/58）+
      产品增强（前端三域面板/双端 /panel 对账/联调剧本 19 项）+ 工程化收官
      （spec 0.7.0/CI runtime 段/上线指南/性能基线/收官总览）全部达成。
- [x] **门禁**: consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、
      sigma-runtime 59/59 + 58/58、双端冒烟 37/37、sigma-accept 十道门禁
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、bench 4/4、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.120 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: ready 命令实测 7/7、consensus 54/54、p0 109/109、
      sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.121 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **docs/TUTORIAL.md**: 144 行命令级可复现教程——环境准备 / 读规则 /
      ...
      检查清单 / 下一步。
- [x] **不回归**: 自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、
      sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.123 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **不回归**: 自检 15/15、冒烟 36/36、panel-test 5/5、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.133 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **corpus/socketkit_systems_ok.md**: 13 个 Operation 跨制度联动（额度/积分/
      勋章/团/督导），正例 + ⊥ 负例齐全；三端共识 **51/52 → 54/54**（修复
      指纹/encode 函数/负例跨端一致性），证明 27 PROVED。
- [x] **不回归**: 共识数字全库同步 54/54、health-test 4/4、panel-test 5/5、
...
- [x] **不回归**: web-test 5/5、stats-test 5/5、自检 15/15、consensus 54/54、
      p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，v0.10–v0.137 全部
      保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **Rust /stats**: app.rs 新增 /stats 路由（与 Python v0.134 对等），/panel
      gates 数字同步 54/54、109 PROVED；run_smoke 37 → 38 项对账。
...
- [x] **数字一致**: consensus 54/54、prove 109 PROVED 在门禁与 /health//panel
...
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、stats-test
      5/5、双端 38/38、consensus 54/54、p0 109/109、三端 0 warning，
      v0.10–v0.142 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。
...
- [x] **corpus/portfolio_systems_ok.md**: 5 个 Operation 跨操作联动（开户/买入/
      ...
      **54/54**（19/19 PASS），证明 14 PROVED；共识数字全库同步 54/54。
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、stats-test
      5/5、consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
      0 warning，v0.10–v0.143 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.145 完成定义（运行时不变量复核扩展，2026-08-05 立项 → 2026-08-05 达成）

- [x] **--domains 58/58**: run_invariant_checks 追加 INV-PF-4（交易链可加性）/
...
- [x] **v0.146 收官总览**: README Status 章节新增当前状态总览（54/54、110 项
      PROVED、58/58、38/38、19/19、88/88、5/5、十道门禁、小阶段 13/496）。
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
...
- [x] **不回归**: --portfolio-test 5/5、--app-smoke 43/43、Elixir §PF 8/8、§IN
      6/6、自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、sigma-prove 110
      项 PROVED、三端 0 warning，v0.10–v0.150 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.152 完成定义（批次 2 收尾 + 数字同步，2026-08-05 立项 → 2026-08-05 达成）

- [x] **数字一致**: consensus 54/54、prove 110 PROVED、--domains 58/58 在门禁
...
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、
      portfolio-test 5/5、双端 43/43、consensus 54/54、p0 109/109、三端
...
- [x] **corpus/inventory_systems_ok.md**: 5 个 Operation 跨操作联动（开仓/入库链/
      出库链/水位/履约率），正例 + ⊥ 负例齐全；三端共识 **54/54**（15/15 PASS），
      证明 10 PROVED；共识数字全库同步 54/54。
- [x] **不回归**: sigma-accept 10/10、health-test 4/4、panel-test 5/5、stats-test
      5/5、consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
...
- [x] **--domains 58/58**: run_invariant_checks 追加 INV-IN-5（混合货品可加链）
      复核；门禁 7 期望与 --domains 数字全库同步 58/58。
- [x] **不回归**: trace 59/59、--inventory 6/6、sigma-accept 10/10、consensus
      54/54、p0 109/109、sigma-prove 125 项 PROVED、三端 0 warning，
      v0.10–v0.154 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.156 完成定义（README 收官总览数字同步，2026-08-05 立项 → 2026-08-05 达成）

- [x] **v0.156 收官总览**: README Status 章节新增当前状态总览（54/54、125 项
      PROVED、58/58、43/43、19/19、Elixir 三域 88/88+6/6+8/8、5/5、5/5、
      十道门禁、小阶段 23/496）。
- [x] **不回归**: consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
...
- [x] **不回归**: --inventory-test 5/5、--concurrency-test 4/4、--portfolio-test
      5/5、自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、sigma-prove 125
...
- [x] **不回归**: web-test 5/5、inventory-test 5/5、portfolio-test 5/5、自检
      15/15、consensus 54/54、p0 109/109、sigma-prove 125 项 PROVED、三端
...
- [x] **不回归**: --inventory-test 5/5、--app-smoke 44/44、Elixir §IN 7/7、
      自检 15/15、冒烟 36/36、consensus 54/54、p0 109/109、sigma-prove 125 项
      PROVED、三端 0 warning，v0.10–v0.160 全部保持全绿。
- [x] **文档一致**: MASTER_PLAN / README / AUTOPILOT 同步。

### v0.162 完成定义（批次 3 收尾 + 数字同步，2026-08-05 立项 → 2026-08-05 达成）

- [x] **数字一致**: consensus 54/54、prove 125 PROVED、--domains 58/58 在门禁
...
- [x] **三端执行层同步**: `sigma_core.py` 130/130；Rust `sk.rs`+`evaluator.rs` /
      Elixir `sigma_verify.exs` 支持三制度（参考实现 + eval_expr + 自检 54/54），
      `cargo build` 0 error/0 warning。
