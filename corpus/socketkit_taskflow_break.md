# Module: socketkit_taskflow_break
# Version: 1.0.0
...
# Intent: negative counterpart of socketkit_taskflow_ok.md — task_create
# declares fingerprint, laws, and success tests but NO negative (⊥/error-path)
# test, so Law XIV (E-02) must reject it identically across Python / Rust /
# Elixir. Created at v0.57 (corpus expansion).
