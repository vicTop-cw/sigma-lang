...
- ✅ **REACHED v0.120 (2026-08-05)**: 里程碑达成—— v0.100–v0.120 连续推进
  ...
  --deploy-accept 9/9 + --bench 性能基线；consensus 51/51、p0 109/109、
...
- ✅ **REACHED v0.121 (2026-08-05)**: 上线就绪检查—— `sigma_app.py`
  ...
  bench 4/4 不回归；consensus 51/51、p0 109/109，v0.10–v0.120 不回归。
- ⏳ **待办队列（avatar_loop 目标来源，一天一个）**:
  1. ⏸️ P3 — Lang-Zone backend integration（§6.1，**DEFERRED**：LZ 尚在原型期，待自举稳定后再融入）。
  2. （无）— v0.121 达成，继续 v0.122–v0.123 生产部署脚本 + 验证收官。
